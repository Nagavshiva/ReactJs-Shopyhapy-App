...
const Products = (props) => {
  ...
  const ShowProducts = () => {
    return (
      <>
        <div className="buttons d-flex justify-content-center mb-5 pb-10 ">
        ...
        {filter.map((product) => {
          return (
            <>
             <div className="col-md-3 mb-4 pro ">
              <div class="card h-100 text-center p-3" key={product.id}>
                ...
                <div class="card-body ">
                  ...
                  <NavLink to={`/products/${product.id}`}><button class="btn btn-outline-dark">Buy Now</button></NavLink>
                </div>
              </div>
              </div>
            </>
